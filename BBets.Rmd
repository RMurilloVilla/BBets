...
## Question 1 Deviation and 95% confidence Interval
```{r}
numClass = 45
#ny guess at fair odds = $2:$1
odds = 2
counttoDo = 637
...
When 40 Dr.Brownlow substitutes try this, the average mean is $530 in profit. The confidence interval is between -87 and 111. The Standard deviation is 20.35138.
...
To make the game fair, Brownlow should pay out 'r mean(saveBank).' The score is 8.42.  
...
For the odds to be fair for the 2:1 within the class size. The class size has to be 35 Students to be fair odds for Brownlow. The score is 11.865. 
